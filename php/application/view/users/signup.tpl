...
<div class="container">
	<div class="row">
		...
		<div class="container col-md-12">
			<h2>Tutaj można zgłosić potrzebę posiadania konta w systemie
				jego administratorowi.</h2>

			<div class="row">

				<div class="col-md-6">
					<div class="form-group">
						<label for="exampleInputEmail1">Imię</label> <input type="email"
							class="form-control" id="exampleInputEmail1" placeholder="Imię">
						<div class="form-group"></div>
						<label for="exampleInputEmail1">Nazwisko</label> <input
