...
/**
 *
 * @name ini_configuration @TODO - przenieść wszystkie edytowalne zmienne do pliku default_config
 */
...
/**
 *
 * @name ini_database @TODO: - nawiązać połączenie z bazą danych; @SAMPLE Przykład stosowania połączenia z bazą danych MySQL $data = $database->_mysql->fetch_array('SHOW TABLES');
 */
...
/**
 *
 * @name ini_bootstrap Inicjalizacja wszystkich funkcji, jakie wymagane są do poprawnej pracy systemu. Wczytanie konfiguracji @TODO przeniesienie wszystkich ustanień do pliku ini
 */
