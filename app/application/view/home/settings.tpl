					...
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<p>Sed lacus ante, ullamcorper at pellentesque ac, accumsan
								sed felis. Cras ultrices nibh ut eleifend semper. Aliquam mattis
								vulputate tellus, non auctor sem feugiat non. Nulla congue risus
								arcu, a aliquam est egestas in. Nunc egestas turpis nec magna
								ultricies sollicitudin. Fusce pretium bibendum enim sit amet
								malesuada. Donec et molestie elit. Sed pretium venenatis tempus.
								Praesent lorem felis, scelerisque ac blandit in, scelerisque non
								dolor. Morbi non arcu dapibus, tincidunt metus et, malesuada
								orci. Praesent a quam sed dui accumsan viverra ac eu sapien.
								Nulla sed mi a mauris imperdiet dictum. Class aptent taciti
								sociosqu ad litora torquent per conubia nostra, per inceptos
								himenaeos. Proin ac libero at justo gravida rhoncus.</p>
							<p>
		...
		<div class="list-group">
			<a href="#" class="list-group-item">
				...
				<p class="list-group-item-text">Praesent elementum facilisis
					...
					laoreet. Suspendisse dignissim convallis est in volutpat. Phasellus
					suscipit sapien nibh, at feugiat diam blandit eget. Fusce facilisis
					ultricies ipsum, ac ullamcorper mi lobortis quis. Nulla pretium at
					nulla ut luctus. Praesent laoreet at tortor in porttitor. Duis
					tincidunt euismod lacus, ullamcorper pulvinar augue imperdiet id.
					Integer ut massa gravida, laoreet sapien vitae, rutrum odio.</p>
			</a> <a href="#" class="list-group-item ">
				<h4 class="list-group-item-heading">List group item heading</h4>
				<p class="list-group-item-text">Phasellus consectetur eget risus
					ac ultricies. In porta facilisis varius. Duis sodales interdum
					nulla eget tempus. In ut libero ornare augue viverra convallis a et
					turpis. Pellentesque habitant morbi tristique senectus et netus et
					malesuada fames ac turpis egestas. Lorem ipsum dolor sit amet,
					consectetur adipiscing elit. Aenean mi nisi, elementum id rhoncus
					pulvinar, consectetur at elit. Aliquam tristique facilisis nulla
					non scelerisque. Donec porta aliquet sapien et tempor. Sed vitae
					ligula vitae enim mattis sollicitudin. Vestibulum ante ipsum primis
					in faucibus orci luctus et ultrices posuere cubilia Curae; Praesent
					porttitor porttitor mauris id varius. Cras fringilla augue erat,
					vel hendrerit quam adipiscing et. Vivamus est velit, facilisis sed
					purus accumsan, volutpat vestibulum purus. Morbi viverra convallis
					sapien eget pulvinar.</p>
			</a> <a href="#" class="list-group-item ">
				<h4 class="list-group-item-heading">List group item heading</h4>
				<p class="list-group-item-text">Integer tincidunt est nec nulla
					viverra consectetur. Suspendisse potenti. Sed auctor, lacus at
					commodo rhoncus, ligula turpis suscipit eros, ut ullamcorper ligula
					nisl eu risus. Lorem ipsum dolor sit amet, consectetur adipiscing
					elit. Donec gravida, eros sit amet consectetur vestibulum, diam
					dolor ultrices urna, in malesuada arcu arcu non elit. Donec
					faucibus scelerisque mi, vel malesuada odio varius eget. Nunc
					suscipit placerat venenatis. Praesent eget adipiscing arcu. Nam sed
					laoreet nisl. Quisque vehicula tellus ante, ac cursus mauris mattis
					nec. Integer auctor neque vel nunc luctus condimentum. Maecenas
					vitae libero lorem.</p>
			</a> <a href="#" class="list-group-item ">
				<h4 class="list-group-item-heading">List group item heading</h4>
				<p class="list-group-item-text">Ut egestas, enim id euismod
					...
					sapien porttitor felis. Nullam laoreet, magna id tincidunt pretium,
					magna nunc condimentum lacus, sed aliquet sem tellus eget sem.
					Nulla diam tellus, aliquet vitae nisl et, dapibus sagittis metus.
					Sed auctor quam felis, elementum aliquam ipsum dapibus laoreet.
					Mauris pulvinar nulla eu pharetra varius. Quisque in ullamcorper
					magna. Proin blandit urna sit amet imperdiet cursus. In pharetra ac
					neque nec porta. Nullam mattis ipsum vitae dignissim mattis.
					Integer interdum purus vel condimentum convallis. Fusce ullamcorper
					id dui sed lobortis.</p>
			</a>
		</div>
		{else}
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<p>Aenean et nunc pulvinar, ornare nisl nec, tempor elit.
					...
					accumsan vehicula. Vestibulum nec ultrices mi, ut rutrum elit. Nunc
					cursus ultricies commodo.</p>
			</div>
		</div>
	</div>
	{/if}
