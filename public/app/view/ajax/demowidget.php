<p class="alert alert-info">
	...
	<code>
		data-widget-load="<i class="text-primary">[data source]</i>"
	</code>
	. Turn on auto refresh by adding the timer like so
	<code>data-widget-refresh="15"</code>
...
<div class="row">
	<div class="col-sm-7">
		<code>
			data-widget-load="<i class="text-primary">ajax/demowidget.php</i>"
		</code>
	</div>
