...
class Smarty_Internal_Configfileparser // ine 80 "smarty_internal_configfileparser.php"
{
	...
	// ine 174 "smarty_internal_configfileparser.php"
	const TPC_OPENB = 1;
	const TPC_SECTION = 2;
	const TPC_CLOSEB = 3;
	const TPC_DOT = 4;
 ...
 /*  21 */ "newline ::= COMMENTSTART NAKED_STRING NEWLINE" 
	...
	public function yy_shift($yyNewState, $yyMajor, $yypMinor) {
		...
		if ($this->yyidx >= self::YYSTACKDEPTH) {
			...
			// ine 601 "smarty_internal_configfileparser.php"
	...
	// ine 694 "smarty_internal_configfileparser.php"
	// ine 162 "smarty_internal_configfileparser.y"
	function yy_r6() {
		$this->_retvalue = $this->yystack [$this->yyidx + - 1]->minor;
	}
	// ine 699 "smarty_internal_configfileparser.php"
	...
	// ine 704 "smarty_internal_configfileparser.php"
	// ine 170 "smarty_internal_configfileparser.y"
	function yy_r8() {
		$this->_retvalue = Array ();
	}
	// ine 709 "smarty_internal_configfileparser.php"
	...
	public function yy_syntax_error($yymajor, $TOKEN) {
		...
		// ine 816 "smarty_internal_configfileparser.php"
	}
	public function yy_accept() {
		...
		// echo $this->retvalue."\n\n";
		// ine 833 "smarty_internal_configfileparser.php"
	}
