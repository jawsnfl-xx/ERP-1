...
namespace Framework
{
    ...
    class Template extends Base
    {
         ...
         *
         * @param unknown $source            
         * @return boolean multitype:boolean unknown |multitype:boolean Ambigous
         *         <NULL, unknown> Ambigous <unknown, string> unknown Ambigous
         *         <multitype:, \Framework\multitype:unknown, multitype:unknown
         *         >
         */
        protected function _tag ($source)
        {
            ...
            if (isset($type["arguments"])) {
                ...
                if ($tag && isset($type["tags"][$tag]["arguments"])) {
                    $arguments = $this->_arguments($extract, 
                            $type["tags"][$tag]["arguments"]);
                }
            return array(
                    "tag" => $tag,
                    "delimiter" => $delimiter,
         ...
         *
         * @param unknown $source            
         * @return multitype:Ambigous <\Framework\multitype:, boolean> Ambigous
         *         <\Framework\multitype:, boolean, multitype:>
         */
        protected function _array ($source)
        {
            ...
            while ($source) {
                ...
                $closer = strpos($source, $type["closer"]) +
                         strlen($type["closer"]);
                if ($opener !== false) {
                ...
                if ($result) {
                    ...
                    if ($tag) {
                        if (! $result["closer"]) {
                            ...
                            $current = & $current["children"][sizeof(
                                    $current["children"]) - 1];
                        } else 
        ...
        {
            if (! is_a($this->_implementation, 
                    "Framework\Template\Implementation")) {
