...
<div class="container-fluid">
	...
	<div class="container-fluid">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>12</td>
						<td>13</td>
						<td>14 <span class="badge">!</span></td>
						<td>15</td>
						<td>16</td>
					</tr>
					<tr>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<select class="form-control"><option>Miesiąc</option>
			...
			<div class="col-md-3">
				<select class="form-control"><option>Rok</option>
					<option>2013</option>
					<option>2014</option>
					<option>2015</option>
					<option>2016</option>
			...
			<button class="btn btn-primary">Przejdź do daty</button>
		</div>
	</div>
</div>
</div>